...
def encrypt_oracle():
    ...
    cls_info = {
                ...
                '热轧':{
                       '英文':['bahen', 'tuopi', 'huashang', 'jiaza', 'yiwuyaru', 'bianlie','gunyin', 'yanghuatiepi', 'zongxiangliewen', 'hengxiangliewen',
                             'zangwu', 'cashang', 'kongdong','penma', 'guahen', 'tielin','daifenlei','sheweiyin','gangyin','yayang','kunzhayin','aokeng',
                             'XiuMoYin','TingJiWenLi'],

                       '中文':['疤痕', '脱皮', '划伤', '夹杂', '异物压入','边裂', '辊印', '氧化铁皮', '纵向裂纹', '横向裂纹',
                             '脏污','擦伤', '孔洞', '喷码', '刮痕', '铁磷','待分类','舌尾印','钢印','压氧','捆扎印','凹坑',
                             '修磨印','停机纹理']
                       },
                '板材':{
