...
def encrypt_oracle():
    ...
    cls_info = {
                ...
                '冷轧':{
                      '英文':['SuiBian', 'ZheBian', 'QieKouBuLiang', 'KuanDuYiChang', 'JiaShang', 'JuBuWeiQieBian', 'CanJian', 'HouDuYiChang', 'BianSun', 'GuaBian', 'GongQi', 'QiaoQu',
                            ...
                            'QianSuan', 'GuoSuan', 'ZhenHen', 'JiaHen', 'GangJuanZheHen', 'TingJiHen','XiuPiYaRu', 'NianJiao', 'YouJiao', 'ShuiXiBuLiang', 'ShuiYin', 'ShuaGunYin',
                      ...
                      '中文':['碎边', '折边', '切口不良', '宽度异常', '夹伤', '局部未切边', '残剪', '厚度异常', '边损', '刮边', '拱起', '翘曲', '中浪', '边浪', '起鼓', '镰刀弯', '整面浪状', '交叉浪',
                            '弧形', '硬卷', '夹渣', '孔洞', '表面分层', '边丝压入', '热抓伤', '夹层', '电击伤', '氧化皮痕', '辊印', '脏污', '表面裂纹', '异物压入', '划伤', '凿伤', '擦伤', '2B小白点',
                            '氧残', '脱皮', '热裂辊纹', '折叠', '表面粗糙', '锈斑', '气孔脱皮', '蚀孔点蚀', '斑点', '酸印', '退火过度', '退火不足', '欠酸', '过酸', '振痕', '夹痕', '钢卷折痕', '停机痕',
                ...
                '热轧':{
                       '英文':['DaiFenLei', 'JingZhaGunYin', 'DaiTouGunYin', 'ZhaLan', 'KongDong', 'ZhaRuWaiWu','BaoPian', 'JieBa', 'XianZhuangJiaZa', 'ZhuPiHuaShang', 'ZongXiangLieWen',
                             'GuaHen','LiangHuaShang', 'XiaFeng', 'YiCiXiuPi', 'ErCiXiuPi', 'TieLinYaRu', 'YangHuaTiePi','ZhenHen', 'PianZhuangTieLin', 'BoXing', 'ShuiDi', 'ShuiWu',
                             'ShuiYin','BaoGuangYinHen', 'TingZhiShuXian', 'BaiTieLin', 'BeiJingYi', 'BeiJingEr', 'BeiJingSan','BeiJingSi', 'QiPi', 'TouWeiBian', 'BianYuanPoLie',
                             'BeiJingWu', 'BeiJingLiu','BianYuanMaoCi', 'GuoBaoGuang', 'XiuPiTuoLuo', 'CaBa', 'BeiJingQi', 'BeiJingBa','YiWuYaRu', 'TuBao', 'LaSiYaRu', 'ZongXiangHuaShang',
                             'AoKeng', 'CaShang', 'HuaShang', 'TiaoZhuangChongPi'],

                       '中文':['待分类', '精轧辊印', '带头辊印', '轧烂', '孔洞', '轧入外物','剥片', '结疤', '线状夹杂', '铸坯划伤', '纵向裂纹', '刮痕','亮划伤', '狭缝', '一次锈皮', '二次锈皮', '铁鳞压入', '氧化铁皮',
                             '振痕','片状铁鳞', '波形', '水滴', '水雾', '水印','曝光印痕', '停止竖线', '白铁鳞', '背景一', '背景二', '背景三','背景四', '起皮', '头尾边', '边缘破裂', '背景五', '背景六','边缘毛刺',
                             '过曝光', '锈皮脱落', '擦疤', '背景七', '背景八','异物压入', '凸包', '拉丝压入', '纵向划伤', '凹坑', '擦伤', '划伤', '条状重皮']
                       },
                '板材':{
