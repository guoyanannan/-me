    ...
    cls_info = {
                ...
                '热轧':{
                       '英文':['DaiFenLei', 'XianZhuangGunYin','JingZhaGunYin', 'DaiTouGunYin', 'YaLan', 'KongDong', 'ZhaRuWaiWu','BaoPian', 'JieBa', 'XianZhuangJiaZa', 'ZhuPiHuaShang', 'ZongXiangLieWen', 'GuaHen','LiangHuaShang', 'XianFeng', 'YiCiXiuPi', 'ErCiXiuPi', 'TieLinYaRu', 'YangHuaTiePi',
                             ...
                             'ReZhaGunYin','ReZhaJiaSongGunYin','ReZhaYangHuaPiBoLi','ReZhaZhanGang','XiuMoYin','ShuiLiangYin','CeFanXian','LieBian','LieKou','BaHen','JiaZa','GunYin','ZangWu','PenMa','SheWeiYin','GangYin','ReZhaBianLang','ReZhaGuaZaoShang','ReZhaZhongBo','ReZhaYaBianXiu',
                             ],
                       ...
                       '中文':['待分类', '线状辊印','精轧辊印', '带头辊印', '轧烂', '孔洞', '轧入外物','剥片', '结疤', '线状夹杂', '铸坯划伤', '纵向裂纹', '刮痕','亮划伤', '狭缝', '一次锈皮', '二次锈皮', '铁鳞压入', '氧化铁皮',
                             ...
                             '热轧辊印','热轧夹送辊印','热轧氧化皮剥离','热轧粘钢','修磨印','水梁印','侧翻线','裂边','裂口','疤痕','夹杂','辊印','脏污','喷码','舌尾印','钢印','热轧边浪','热轧刮凿伤','热轧中波','热轧压边锈',
                             ]
                       },
                '板材':{
                       '英文':['DaiFenLei', 'ZongXiangLieWen', 'HengXiangLieWen', 'BianLie', 'ShuiYin', 'GunYin',
                           'YaKeng', 'QiaoPi', 'XianXingQueXian', 'HuaShang', 'YaHen', 'ShuiDi','BianXian','ZheBian','HuaBan',
